<%-- 
    Document   : zakazivanjeTermina
    Created on : Oct 4, 2018, 8:01:42 AM
    Author     : Jelena
--%>
...
<br/><br/><br/>
<h3 style="text-align: center">Rezervacija termina za centar</h3>
<br/><br/>
<div class="container">
    <div class="col-md-6 col-md-offset-3">
        ...
        <form:form method="POST" modelAttribute="zakazivanjeTermina">
            ...
            <button type="submit" class="btn btn-primary" style="display: block; margin: auto; background-color: teal">Rezervisi termin</button>
        </form:form>
    </div>
</div>
