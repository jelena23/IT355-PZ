<%-- 
    Document   : addTermin
    Created on : Oct 4, 2018, 7:58:14 AM
    Author     : Jelena
--%>
    ...
    <div class="container">
        ...
        <form:form method="POST" action="${post_url}" modelAttribute="termin">
            ...
            <div class="form-group">
                <form:label for="fitnesCentar" path="fitnesCentar">Fitnes Centar</form:label>
                <form:select id="slcRole" class="form-control" path="fitnesCentar">
                    <form:option value="">ODABERITE CENTAR</form:option>
                    <form:options items="${fitnesCentri}" itemValue="idFitnesCentar" itemLabel="imeFitnesCentar" />
                </form:select>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary" style="background-color: teal; margin-left: 37%">Dodaj termin</button>
        </form:form>
    </div>
</div>
